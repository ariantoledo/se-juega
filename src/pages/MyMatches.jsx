    ...
    <div className="max-w-5xl mx-auto px-4 py-6 pb-24 md:pb-6">
      ...
      <Tabs defaultValue="created" className="w-full">
        <TabsList className="w-full mb-6">
          <TabsTrigger value="created" className="flex-1">Creados ({createdMatches.length})</TabsTrigger>
          <TabsTrigger value="joined" className="flex-1">Me uní ({joinedMatches.length})</TabsTrigger>
        </TabsList>
