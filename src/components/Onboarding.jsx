...
const STEPS = [
  {
    ...
    title: "Bienvenido a\nSe Juega",
    subtitle: "Encontrá partidos de fútbol y pádel,\narmá tu equipo y reservá tu cancha.",
  },
  {
    type: "feature",
    icon: Search,
    ...
    description: "Explorá partidos abiertos de fútbol y pádel cerca tuyo. Filtrá por tipo de deporte, nivel y sumate al equipo que necesita jugadores.",
    tag: "BUSCAR",
  },
  {
    type: "feature",
    ...
    description: "Organizá un partido de fútbol o pádel en minutos. Definí cuántos jugadores necesitás, nivel de juego y posiciones faltantes.",
    tag: "CREAR",
  },
  {
    type: "feature",
